...
// Ensure index.html is served for the root path and any unmatched routes
app.get('/', (req, res) => {
...
// Catch-all route to serve index.html for any unmatched routes (for SPA functionality)
app.get('*', (req, res) => {
  // Skip API routes
